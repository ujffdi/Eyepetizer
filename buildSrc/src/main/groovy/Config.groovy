class Config {
    ...
    static modules = [
            ...
            feature_eyepetizer_pkg   : new DepConfig(true, true, ":feature:eyepetizer:pkg"),
            feature_eyepetizer_export: new DepConfig(true, true, ":feature:eyepetizer:export"),
    ...
    static libs = [
            ...
            retrofitConverter       : new LibConfig(path: "com.squareup.retrofit2:converter-gson:$retrofitVersion"),
            // 启动框架。TheRouter有类似的功能
