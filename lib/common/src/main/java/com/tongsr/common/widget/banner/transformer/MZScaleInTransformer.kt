 ...
 */
class MZScaleInTransformer @JvmOverloads constructor(private val minScale: Float = DEFAULT_MIN_SCALE): BasePageTransformer() {
    ...
    override fun transformPage(view: View, position: Float) {
        ...
        if (currentPos <= -1.0f) {
            ...
            val scale = (1.0f - minScale) * Math.abs(1.0f - Math.abs(currentPos))
